...
export const Footer: React.FC<FooterItemProps> = () => {
  return (
    <footer className="relative w-full border-t-[1px] border-solid border-accent/80 bg-footerBcg pb-[19px] pt-6 md:border-none md:pb-6 xl:border-t-[1px] xl:border-solid xl:border-accent/80 xl:pt-8">
