...
export const Button: React.FC<ButtonProps> = ({
  ...
  const btnStyles = classNames(
    ...
    {
      'py-4 px-12 max-w-80 bg-accent text-white transition duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] xl:max-w-[198px]':
        accent === true,
      'hover:bg-hover focus:bg-hover active:bg-pressed': accent === true,
      'py-3 px-6 max-w-80 bg-transparent text-accent transition duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] border border-solid border-accent xl:max-w-[187px]':
        accent === false,
